      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="p-8 rounded-2xl border border-white/[0.08]"
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs font-medium text-white/30 uppercase tracking-wider">Atau masuk dengan</span>
            <div className="flex-1 h-px bg-white/[0.06]"></div>
          </div>
          ...
          <p className="text-center text-sm text-white/40 mt-8">
            Belum punya akun?{' '}
            <Link href={`/${lang}/register`} className="text-orange-400 hover:text-orange-300 font-medium transition-colors">
              Daftar gratis
            </Link>
          </p>
        </div>
